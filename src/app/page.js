...
export default function Home() {
  ...
  const modules = results ? [
    { label: 'robots.txt', data: results.robots, max: 25, icon: Shield }, { label: 'llms.txt', data: results.llms, max: 20, icon: FileText }, { label: 'sitemap.xml', data: results.sitemap, max: 15, icon: FolderTree },
    { label: 'Meta Title', data: results.meta, max: 10, icon: Tag }, { label: 'Open Graph', data: results.openGraph, max: 15, icon: Share2 }, { label: 'Schema.org', data: results.schema, max: 15, icon: Code }
  ] : [];
