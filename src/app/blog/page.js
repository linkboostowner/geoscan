...
const posts = [
  ...
  {
    slug: 'structured-data-dlya-ai-poiskovikov',
    title: 'Structured Data для AI-поисковиков: что такое Schema.org и как её добавить',
    date: '2026-05-30',
    excerpt: 'Разбираем, что такое Schema.org, почему она важна для GEO и как добавить структурированные данные на сайт за 10 минут.',
  },
  {
    slug: 'kak-otslezhivat-vidimost-v-ai-poiskovikah',
    title: 'Как отслеживать видимость сайта в AI-поисковиках: мониторинг и rank tracking',
    date: '2026-05-31',
    excerpt: 'Рассказываем, как отслеживать позиции сайта в ChatGPT и Perplexity, и почему одного аудита недостаточно.',
  },
];
